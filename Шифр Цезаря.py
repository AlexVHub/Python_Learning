direction = input('Выберите направление шифровать текст "ш" или дешифровать текст "д"', )
...
print(crypto(language_lower, language_upper, language_len, shift, string))